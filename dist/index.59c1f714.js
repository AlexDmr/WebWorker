...
let str = ``;
for(let i = MIN; i <= MAX; i++)str += `<tr><td>Fibonnacci(${i})</td><td></td><td></td></tr>`;
tbody.innerHTML = str;
// Get button reference
const bt = document.querySelector("button");
// Load and create 2 workers, subscribe to the button to start computation
Promise.all([
    _utils.loadAsBlob('./fibonnacci1.ts'),
    _utils.loadAsBlob('./fibonnacci2.ts')
]).then(([b1, b2])=>{
...
async function go(w1, w2) {
    ...
    w2.onmessage = (msg)=>{
        ...
        if (msg.data.nb < MAX) w2.postMessage(msg.data.nb + 1);
    };
    w1.onerror = console.error;
    w2.onerror = console.error;
}

},{"./style.css":"fQKL0","./utils":"k2UnE"}],"fQKL0":[function() {},{}],"k2UnE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadAsBlob", ()=>loadAsBlob
);
async function loadAsBlob(f) {
...
},{}]},["7SOzi","gK55r"], "gK55r", "parcelRequire4561")
